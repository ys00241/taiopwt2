...
class Member(db.Model):
    ...
    end_year = db.Column(db.Integer, comment="退會年份")
    name_alais = db.Column(db.String(200), comment="別名")
    group_name = db.Column(db.String(200), comment="群體名")
    referrer = db.Column(db.String(200), comment="介紹人")
